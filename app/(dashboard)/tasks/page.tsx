...
const AddTaskModalDyn = dynamic(() => import("@/components/AddTaskModal"), { ssr: false });
const EditTaskModalDyn = dynamic(() => import("@/components/EditTaskModal"), { ssr: false });
...
function TasksContent() {
  ...
  return (
    <div>
      ...
      {showAdd && <AddTaskModalDyn onClose={() => setShowAdd(false)} onAdd={handleAdd} />}
      {editTask && <EditTaskModalDyn task={editTask} onClose={() => setEditTask(null)} onSave={handleEdit} />}
